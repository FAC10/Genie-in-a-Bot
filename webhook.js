    ...
    data.entry.forEach((entry) => {
      ...
      console.log(event);
        var messageData = {
          ...
          message: [{ text:
'Hey [name], I am your personal assistant in the run up to the General Elections!. Type your postcode or send me your location to get started.' , quick_replies: [{ content_type: 'location' }
] }],
          }
