...
function construct(partyVotesObj, firstName) {
  ...
  const answer_objects = {
    ...
    Election_Info :{
      text: 'The United Kingdom general election of 2017 is scheduled to take\
       place on 8 June 2017. Each of the 650 parliamentary constituencies will elect\
        one Member of Parliament (MP) to the House of Commons, the lower house of\
         Parliament. In line with the Fixed-term Parliaments Act 2011, an election had\
