...
get.candidates = (constituency, callback) => candidateConnect.query('SELECT name, party_name, twitter_username, image_url FROM temp2 WHERE post_label = $1;', [constituency], (err, res) => {
  if (err) {
    return callback(err);
  }
  return callback(null, res);
